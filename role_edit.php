        ...
        <table class="table table-bordered table-responsive-lg table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="checkbox" name="create_waste" <?php echo ($role['create_waste'] == 1) ? 'checked' : ''; ?>></td>
                    <td><input type="checkbox" name="view_waste" <?php echo ($role['view_waste'] == 1) ? 'checked' : ''; ?>></td>
                    <td><input type="checkbox" name="edit_waste" <?php echo ($role['edit_waste'] == 1) ? 'checked' : ''; ?>></td>
                    <td><input type="checkbox" name="delete_waste" <?php echo ($role['delete_waste'] == 1) ? 'checked' : ''; ?>></td>
                </tr>
                <tr>
