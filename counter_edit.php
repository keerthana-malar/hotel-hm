...
// Get the counter ID from the URL
$counterId = $_GET['id'];

// Query the database to retrieve the existing data for the specified counter
$editSql = "SELECT * FROM `counter` WHERE id = :counterId";
$editStmt = $pdo->prepare($editSql);
$editStmt->bindParam(':counterId', $counterId, PDO::PARAM_INT);
$editStmt->execute();
$counterData = $editStmt->fetch(PDO::FETCH_ASSOC);
...
<div class="main-box">
    <div class="col-12">
        <div class="form-group amt-box">
            ...
            <input type="number" class="form-control" name="five_h" value="<?php echo $counterData['five_h'] ?>">
            <input type="number" disabled class="form-control" name="five_h_t" value="<?php echo $counterData['five_h_t'] ?>">
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="form-group amt-box">
            ...
            <input type="number" class="form-control" name="two_h" value="<?php echo $counterData['two_h'] ?>">
            <input type="number" disabled class="form-control" name="two_h_t" value="<?php echo $counterData['two_h_t'] ?>">
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="form-group amt-box">
            ...
            <input type="number" class="form-control" name="one_h" value="<?php echo $counterData['one_h'] ?>">
            <input type="number" disabled class="form-control" name="one_h_t" value="<?php echo $counterData['one_h_t'] ?>">
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="form-group amt-box">
            ...
            <input type="number" class="form-control" name="fifty" value="<?php echo $counterData['fifty'] ?>">
            <input type="number" disabled class="form-control" name="fifty_t" value="<?php echo $counterData['fifty_t'] ?>">
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="form-group amt-box">
            ...
            <input type="number" class="form-control" name="twenty" value="<?php echo $counterData['twenty'] ?>">
            <input type="number" disabled class="form-control" name="twenty_t" value="<?php echo $counterData['twenty_t'] ?>">
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="form-group amt-box">
            ...
            <input type="number" class="form-control" name="ten" value="<?php echo $counterData['ten'] ?>">
            <input type="number" disabled class="form-control" name="ten_t" value="<?php echo $counterData['ten_t'] ?>">
        </div>
    </div>
    ...
    <div class="col-12">
        <div class="form-group amt-box">
            ...
            <input type="number" class="form-control" name="five" value="<?php echo $counterData['five'] ?>">
            <input type="number" disabled class="form-control" name="five_t" value="<?php echo $counterData['five_t'] ?>">
        </div>
    </div>
                        </div>
                        <br> 
    ...
    <div class="col-12 col-md-6 col-lg-4">
        <div class="form-group">
            ...
            <input disabled type="number" class="form-control" name="cash" value="<?php echo $counterData['cash_t'] ?>">
        </div>
    </div>
    <div class="col-12 col-md-6 col-lg-4">
        <div class="form-group">
            <label>Card</label>
            <input type="number" class="form-control" name="card" value="<?php echo $counterData['card'] ?>">
        </div>
    </div>
    ...
    <div class="col-12 col-md-6 col-lg-4">
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="due_amt" value="<?php echo $counterData['due_amt'] ?>">
        </div>
    </div>
    ...
    <div class="col-12 col-md-6 col-lg-4">
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="due_payment" value="<?php echo $counterData['due_payment'] ?>">
        </div>
    </div>
    <div class="col-12 col-md-6 col-lg-4">
        <div class="form-group">
            <label for="exampleInputPassword4">Net Total</label>
            <input disabled type="number" class="form-control" name="net_total" value="<?php echo $counterData['net_total'] ?>">
        </div>
    </div>
    ...
    <div class="col-12  col-md-6 col-lg-4">
        <div class="form-group">
            ...
            <input type="number" class="form-control" name="delivery_sales" value="<?php echo $counterData['delivery_sales'] ?>">
        </div>
    </div>
    <div class="col-12  col-md-6 col-lg-4">
        <div class="form-group">
            <label for="exampleInputPassword4">Expenses</label>
            <input type="number" class="form-control" name="expenses" value="<?php echo $counterData['expenses'] ?>">
        </div>
    </div>
    <div class="col-12  col-md-6 col-lg-4">
        <div class="form-group">
            <label for="exampleInputPassword4">Outdoor Sale</label>
            <input type="number" class="form-control" name="outdoor_sale" value="<?php echo $counterData['outdoor_sales'] ?>">
        </div>
    </div>
    <div class="col-12  col-md-6 col-lg-4">
        <div class="form-group">
    ...
    <div class="col-12  col-md-6 col-lg-4">
        <div class="form-group">
            ...
            <select class="form-control" name="status" id="">
                <option  value="pending" class="text-danger" <?php if($counterData['status'] == 'pending'){echo 'selected';} ?> >Pending</option>
                <option value="received" class="text-success" <?php if($counterData['status'] == 'received'){echo 'selected';} ?> >Received</option>
            </select>
        </div>
    </div>
    <div class="col-12  col-md-6 col-lg-4">
        <div class="form-group">
            ...
            <input disabled type="number" class="form-control" name="shortage" value="<?php echo $counterData['shortage'] ?>">
        </div>
    </div>
    <div class="col-12  col-md-6 col-lg-4">
        <div class="form-group">
            <label for="exampleInputPassword4">Excess</label>
            <input disabled type="number" class="form-control" name="excess" value="<?php echo $counterData['excess'] ?>">
        </div>
    </div>
    <div class="col-12 col-md-6 col-lg-4">
        <div class="form-group">
            <label for="exampleInputPassword4">To Accounts Department</label>
            <input disabled type="number" class="form-control" name="acc_dep" value="<?php echo $counterData['acc_dep'] ?>">
        </div>
    </div>
    </div>
