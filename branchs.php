...
<div class="main-box">
  <div class="d-flex justify-content-end mb-5">
    <a href="create-branch.php">
      <button class="btn btn-success" <?php if ($rdata["create_b"] === "0") {
        echo "disabled";
      } ?>>Create</button>
    </a>
  </div>
  ...
  if ($branchData) {
    ...
    foreach ($branchData as $row) {
      ...
      echo "<td>
            <a class='" . $dslinkEdit . "' id='' href='edit-branch.php?id=" . $row['id'] . "'><i class=' typcn typcn-edit'></i></a> |
            <a id='" . $admin . "' href='delete-branch.php?delete_id=" . $row['id'] . "' class='text-danger " . $dslinkDelete . $dslinkEditTdy."' onclick='return confirmDelete()'><i class='  typcn typcn-trash'></i></a>
        </td>";
