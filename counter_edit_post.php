...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $counterId = isset($_POST['counterId']) ? $_POST['counterId'] : null;
    ...
    $sql = "UPDATE counter 
        SET date = :date, 
            ...
            expenses = :expenses, 
            outdoor_sales = :outdoorSales, 
            nd_petty_cash = :nextPetty, 
            shortage = :shortage, 
            excess = :excess, 
            acc_dep = :accDep, 
    ...
    if (!$stmt->execute()) {
        ...
        header("Location: " . $u1 . urlencode('Record Updated Successfully'));
    }
}
?>